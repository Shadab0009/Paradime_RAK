...
distribute_design_views -design_script ../scripts/sta_fullAnalysis_physical.tcl -out_dir fullAnalysis_mode3 -views [list  func_slow_RCMAX func_slow_RCMIN] -analysis_script ../scripts/sta.tcl -save_design all
