...
create_library_set -name libset_fast\
   -timing\
    [list ../work/STYLUS_DB/libs/mmmc/FreePDK45_lib_v1.0_typical.lib\
    ../work/STYLUS_DB/libs/mmmc/PLLCLK.lib\
    ../work/STYLUS_DB/libs/mmmc/ram_256x16A.lib\
    ../work/STYLUS_DB/libs/mmmc/rom_512x16A.lib]
create_library_set -name libset_slow\
   -timing\
    [list ../work/STYLUS_DB/libs/mmmc/FreePDK45_lib_v1.0_worst.lib\
    ../work/STYLUS_DB/libs/mmmc/PLLCLK.lib\
    ../work/STYLUS_DB/libs/mmmc/ram_256x16A.lib\
    ../work/STYLUS_DB/libs/mmmc/rom_512x16A.lib]
...
create_constraint_mode -name test_mode\
   -sdc_files\
    [list ../work/STYLUS_DB/libs/mmmc/dtmf_recvr_core.test.sdc]
create_constraint_mode -name functional_mode\
   -sdc_files\
    [list ../work/STYLUS_DB/libs/mmmc/dtmf_recvr_core.pr.sdc]
create_constraint_mode -name scan_mode\
   -sdc_files\
    [list ../work/STYLUS_DB/libs/mmmc/dtmf_recvr_core.scan.sdc]
...
set_analysis_view -setup [list func_slow_RCMAX func_slow_RCMIN] -hold [list func_slow_RCMAX func_slow_RCMIN]
